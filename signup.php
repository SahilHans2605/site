...
<html lang="en">
  <head>
 <title>Beauty Parlour Management System | Sign Up Page</title>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+44 99 555 42">+<?php  echo $a=9815380670;?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:example@mail.com" class="mail"><?php  echo $r="beautyinfo@gmail.com";?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p class="para"> <?php  echo $b="Sector 10,Chandigarh";?></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
                        ...
                        <div class="cont-right">
                            <h6>Time</h6>
                            <p class="para"> <?php  echo $row="10am to 8pm";?></p>
                        </div>
                    </div>
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <h3>Register with us!!</h3>
                    <form method="post" name="Sign Up" onsubmit="return checkpass();">
